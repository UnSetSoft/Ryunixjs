...
If you've found a security vulnerability in RyunixJS, please do not open a
public issue. Instead, report it privately to the maintainers.
...
- **Path Traversal Protection**: Validation of file paths in the production

  server.

- **Prototype Pollution Guard**: Sanitization of props during island hydration.
- **Dangerous URI Blocking**: Automatic blocking of `javascript:` and
