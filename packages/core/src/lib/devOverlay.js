...
export function RyunixDevOverlay(propsOrError) {
    ...
    if (error && error.stack) {
        stackLines = typeof error.stack === 'string' ? error.stack.split('\n').filter((line) => {
            ...
            return !isInternal;
        }) : Array.isArray(error.stack) ? (error.stack) : [];
    }
    ...
    return createElement('div', { style: overlayStyle }, createElement('div', { style: modalStyle }, createElement('div', { style: headerStyle }, createElement('div', { style: { display: 'flex', alignItems: 'center', gap: '12px' } }, createElement('span', { style: badgeStyle }, badgeText), createElement('span', { style: { color: '#9ca3af', fontSize: '14px' } }, 'Ryunix Development')), createElement('button', {
        ...
        title: 'Reload page'
    }, createElement('svg', { width: '20', height: '20', viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', strokeWidth: '2', strokeLinecap: 'round', strokeLinejoin: 'round' }, createElement('path', { d: 'M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8' }), createElement('path', { d: 'M3 3v5h5' })))), createElement('div', { style: contentStyle }, createElement('h1', { style: titleStyle }, createElement('span', { style: { color: '#f87171' } }, errorName), ': ', errorMessage), errorFile && createElement('div', { style: { marginBottom: '16px', color: '#9ca3af', fontSize: '14px', display: 'flex', alignItems: 'center', gap: '8px' } }, createElement('svg', { width: '16', height: '16', viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', strokeWidth: '2', strokeLinecap: 'round', strokeLinejoin: 'round' }, createElement('path', { d: 'M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z' }), createElement('polyline', { points: '13 2 13 9 20 9' })), errorFile, ':', errorLine), snippet && createElement('div', { style: snippetContainerStyle }, createElement('div', { style: { display: 'flex', flexDirection: 'column' } }, ...snippetLines.map((lineText, index) => {
        const currentLineNumber = startLine + index;
        const isErrorLine = currentLineNumber === errorLine;
        return createElement('div', { key: index, style: lineStyle(isErrorLine) }, createElement('span', { style: { color: '#6b7280', width: '40px', userSelect: 'none', textAlign: 'right', marginRight: '16px', display: 'inline-block' } }, currentLineNumber), createElement('span', { style: { color: isErrorLine ? '#f87171' : '#e5e7eb', whiteSpace: 'pre' } }, lineText || ' '));
    }))), createElement('div', { style: { marginBottom: '16px' } }, createElement('p', { style: { color: '#9ca3af', fontSize: '14px', marginBottom: '8px', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' } }, 'Call Stack'), createElement('div', { style: snippetContainerStyle }, stackLines.length > 0 ? createElement('ul', { style: { listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '12px' } }, ...stackLines.map((line, i) => {
        ...
        return createElement('li', { key: i }, createElement('span', { style: { color: '#60a5fa', fontWeight: 600 } }, fnName), createElement('div', { style: { color: '#6b7280', marginTop: '4px', paddingLeft: '16px', display: 'flex', alignItems: 'center', gap: '8px' } }, createElement('svg', { width: '12', height: '12', viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', strokeWidth: '2', strokeLinecap: 'round', strokeLinejoin: 'round' }, createElement('path', { d: 'M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z' }), createElement('polyline', { points: '13 2 13 9 20 9' })), filePath));
