...
function tryGitInit(root) {
    ...
    try {
        ...
        didInit = true;
        try {
            (0, child_process_1.execSync)('git checkout -b main', { stdio: 'ignore', cwd: root });
        }
        catch {
            try {
                (0, child_process_1.execSync)('git branch -m main', { stdio: 'ignore', cwd: root });
            }
            catch {
        ...
        (0, child_process_1.execSync)('git commit -m "Initial commit from Create Ryunix App"', {
            stdio: 'ignore',
            cwd: root,
        });
        return true;
