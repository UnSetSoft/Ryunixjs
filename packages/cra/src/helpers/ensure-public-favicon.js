...
const MINIMAL_FAVICON_PNG = Buffer.from('iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAD0lEQVQ42mNk+M9QDwADhgGAWjR9awAAAABJRU5ErkJggg==', 'base64');
function ensurePublicFavicon(appRoot) {
    ...
    if (fs_1.default.existsSync(faviconPath))
        return;
    fs_1.default.mkdirSync(path_1.default.dirname(faviconPath), { recursive: true });
